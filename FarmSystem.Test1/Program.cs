...
***************************************************************************************************************/
        private static void Excercise1()
        {
            ...
            // Creating instances of animals and adding them to the fame
            Animal cow = new Cow();
            farm.Enter(cow);
 ...
 *****************************************************************************************************************/
        private static void Excercise2()
        {
            ...
            // Making all animals in the farm make noise
            farm.MakeNoise();
            Console.ReadKey();
        }
...
********************************************************************************************************************/
        ...
        // Event handler for when the farm becomes empty
        private static void OnFarmEmpty(object sender, EventArgs e)
        {
